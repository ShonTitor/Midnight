...
happyReduce_49 = happyMonadReduce 7 16 happyReduction_49
happyReduction_49 (_ `HappyStk`
	...
	happyRest) tk
	 = happyThen (( do
        insertarExp (happy_var_3)
        return (If [(happy_var_3, happy_var_6)]))
	) (\r -> happyReturn (HappyAbsSyn16 r))

happyReduce_50 = happyMonadReduce 7 16 happyReduction_50
happyReduction_50 (_ `HappyStk`
	...
	happyRest) tk
	 = happyThen (( do
        insertarExp (happy_var_3)
        return (If [(Not happy_var_3, happy_var_6)]))
	) (\r -> happyReturn (HappyAbsSyn16 r))
...
happyReduction_51 ((HappyAbsSyn17  happy_var_8) `HappyStk`
	...
	happyRest) tk
	 = happyThen (( do
        insertarExp (happy_var_3)
        return (If ((happy_var_3, happy_var_6) : happy_var_8)))
	) (\r -> happyReturn (HappyAbsSyn16 r))
